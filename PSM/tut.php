...
<html lang="en">
  ...
  <head>
    ...
    <meta name="title" content="ASD | Dashboard" />
...
if (!isset($_SESSION['name'])) {
 echo "<h1 style='color:red; text-align:center;'>Unauthorized access , please <a href='index.php'>login</a></h1>";
  exit();
}                    
                    ?>
    <!--begin::App Wrapper-->
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="./forms/pet.php" class="nav-link">
              ...
              <li class="nav-item">
                <a href="./forms/owner.php" class="nav-link">
                  <i class="nav-icon bi bi-pencil-square"></i>
                  <p>
                    Owner
                    <i class=""></i>
               ...
               <li class="nav-item">
                <a href="./forms/doctor.php" class="nav-link">
                  <i class="nav-icon bi bi-pencil-square"></i>
                  <p>
                    Doctor
                    <i class=""></i>
               ...
               <li class="nav-item">
                <a href="./forms/payment.php" class="nav-link">
                  <i class="nav-icon bi bi-pencil-square"></i>
                  <p>
                    Payment
                    <i class=""></i>
