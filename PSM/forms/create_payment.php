        ...
        <nav class="app-header navbar navbar-expand bg-body">
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"><a href="payment.php" class="nav-link">Home</a></li>
...
?>
                                    ...
                                    <?php endif; ?>
                                    <form method="POST">
                                        <div class="mb-3"><label>Appointment ID</label><input name="aid" type="number"
                                                class="form-control" required></div>
                                        <div class="mb-3"><label>Amount</label><input name="amount" type="number"
                                                class="form-control" required></div>
                                        <div class="mb-3">
